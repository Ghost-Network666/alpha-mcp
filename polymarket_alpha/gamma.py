...
def register_gamma_tools(mcp: FastMCP) -> None:
    ...
    def get_gamma_docs() -> dict:
        ...
        return {
            ...
            "official_docs_via_native_tools": "For the complete official Gamma + events + markets + tags + sports API reference pages, call get_polymarket_sitemap() then get_polymarket_doc() on the relevant api-reference/events/* or markets/* paths. Also use list_polymarket_docs() for the curated high-signal subset.",
        }
